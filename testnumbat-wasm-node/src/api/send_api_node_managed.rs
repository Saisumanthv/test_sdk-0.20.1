...
use testnumbat_wasm::{
    ...
    types::{
        BigUint, CodeMetadata, DcdtTokenPayment, ManagedAddress, ManagedArgBuffer, ManagedBuffer,
...
impl SendApi for AndesApiImpl {
    ...
    fn direct_dcdt_execute(
        ...
        self.direct_dcdt_nft_execute(to, token, 0, amount, gas_limit, endpoint_name, arg_buffer)
    }
