use crate::{api::managed_types::big_int_api_node::unsafe_buffer_load_be_pad_right, AndesApiImpl};
use alloc::vec::Vec;
use testnumbat_wasm::{
    ...
    types::{
        ...
        DcdtTokenPayment, ManagedAddress, ManagedArgBuffer, ManagedBuffer, ManagedFrom,
