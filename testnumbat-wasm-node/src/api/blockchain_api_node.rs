...
impl BlockchainApi for crate::AndesApiImpl {
    ...
    #[inline]
    #[cfg(not(feature = "unmanaged-ei"))]
    fn get_state_root_hash(&self) -> testnumbat_wasm::types::ManagedByteArray<Self, 32> {
        unsafe {
            let result_handle = mBufferNew();
            managedGetStateRootHash(result_handle);
            testnumbat_wasm::types::ManagedByteArray::from_raw_handle(self.clone(), result_handle)
        }
    }
    ...
    #[inline]
    #[cfg(not(feature = "unmanaged-ei"))]
    fn get_tx_hash(&self) -> testnumbat_wasm::types::ManagedByteArray<Self, 32> {
        unsafe {
            let result_handle = mBufferNew();
    ...
    #[inline]
    #[cfg(not(feature = "unmanaged-ei"))]
    fn get_block_random_seed(&self) -> testnumbat_wasm::types::ManagedByteArray<Self, 48> {
        unsafe {
            let result_handle = mBufferNew();
    ...
    #[inline]
    #[cfg(not(feature = "unmanaged-ei"))]
    fn get_prev_block_random_seed(&self) -> testnumbat_wasm::types::ManagedByteArray<Self, 48> {
        unsafe {
            let result_handle = mBufferNew();
    ...
    fn get_dcdt_token_data(
        ...
        use testnumbat_wasm::types::BoxedBytes;
        let address = m_address.to_address();
        unsafe {
