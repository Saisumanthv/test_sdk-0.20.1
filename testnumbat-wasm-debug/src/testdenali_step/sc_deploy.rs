...
use testdenali::{TxDeploy, TxExpect};
...
pub fn execute(
    ...
    let tx_input = TxInput {
        ...
        dcdt_token_identifier: tx.dcdt_token_identifier.value.clone(),
...
pub fn sc_create(
    ...
    let dcdt_used = !dcdt_token_identifier.is_empty() && dcdt_value > 0u32.into();
    ...
    if tx_output.result.result_status == 0 {
        ...
        if dcdt_used {
            state.increase_dcdt_balance(&from, &dcdt_token_identifier, &dcdt_value);
        }
    }
