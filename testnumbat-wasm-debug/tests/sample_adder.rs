...
mod module_1 {
    ...
    //////// CONTRACT TRAIT /////////////////////////////////////////////////////////////////////////
    /////////////////////////////////////////////////////////////////////////////////////////////////
    pub trait VersionModule: testnumbat_wasm::contract_base::ContractBase + Sized {
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////
    pub trait AutoImpl: testnumbat_wasm::contract_base::ContractBase {}
    ...
    pub trait EndpointWrappers: VersionModule + testnumbat_wasm::contract_base::ContractBase {
        #[inline]
        fn call_version(&self) {
            testnumbat_wasm::api::CallValueApi::check_not_payable(&self.raw_vm_api());
            let result = self.version();
            testnumbat_wasm::io::EndpointResult::finish(&result, self.raw_vm_api())
        }
    ...
    impl testnumbat_wasm::contract_base::ContractAbiProvider for AbiProvider {
        type Api = testnumbat_wasm::api::uncallable::UncallableApi;

        fn abi() -> testnumbat_wasm::abi::ContractAbi {
            let mut contract_abi = testnumbat_wasm :: abi :: ContractAbi { build_info : testnumbat_wasm :: abi :: BuildInfoAbi { contract_crate : testnumbat_wasm :: abi :: ContractCrateBuildAbi { name : "adder" , version : "0.0.0" , } , framework : testnumbat_wasm :: abi :: FrameworkBuildAbi :: create () , } , docs : & ["One of the simplest smart contracts possible," , "it holds a single variable in storage, which anyone can increment."] , name : "Adder" , constructor : None , endpoints : Vec :: new () , type_descriptions : < testnumbat_wasm :: abi :: TypeDescriptionContainerImpl as testnumbat_wasm :: abi :: TypeDescriptionContainer > :: new () , } ;
            let mut endpoint_abi = testnumbat_wasm::abi::EndpointAbi {
                docs: &[],
                name: "version",
                only_owner: false,
                payable_in_tokens: &[],
    ...
    pub trait ProxyTrait: testnumbat_wasm::contract_base::ProxyObjBase + Sized {
        fn version(
            self,
        ) -> ContractCall<Self::Api, <BigInt<Self::Api> as testnumbat_wasm::io::EndpointResult>::DecodeAs>
        {
            let (___api___, ___address___) = self.into_fields();
            let mut ___contract_call___ = testnumbat_wasm::types::new_contract_call(
                ___api___.clone(),
                ___address___,
                &b"version"[..],
            );
...
mod sample_adder {
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////
    pub trait Adder:
        super::module_1::VersionModule + testnumbat_wasm::contract_base::ContractBase + Sized
    {
        ...
        C: AutoImpl + super::module_1::AutoImpl,
    {
        fn get_sum(&self) -> BigInt<Self::Api> {
            let mut ___key___ =
                testnumbat_wasm::storage::StorageKey::<Self::Api>::new(self.raw_vm_api(), &b"sum"[..]);
            testnumbat_wasm::storage_get(self.raw_vm_api(), &___key___)
        }
        fn set_sum(&self, sum: &BigInt<Self::Api>) {
            let mut ___key___ =
                testnumbat_wasm::storage::StorageKey::<Self::Api>::new(self.raw_vm_api(), &b"sum"[..]);
            testnumbat_wasm::storage_set(self.raw_vm_api(), &___key___, &sum);
        }
        fn callback(&self) {}
        fn callbacks(&self) -> self::CallbackProxyObj<Self::Api> {
            <self::CallbackProxyObj::<Self::Api> as testnumbat_wasm::contract_base::CallbackProxyObjBase>::new_cb_proxy_obj(self.raw_vm_api())
        }
    }

    pub trait EndpointWrappers:
        Adder + testnumbat_wasm::contract_base::ContractBase + super::module_1::EndpointWrappers
    {
        #[inline]
        fn call_get_sum(&self) {
            testnumbat_wasm::api::CallValueApi::check_not_payable(&self.raw_vm_api());
            testnumbat_wasm::api::EndpointArgumentApi::check_num_arguments(&self.raw_vm_api(), 0i32);
        ...
        fn call_init(&self) {
            testnumbat_wasm::api::CallValueApi::check_not_payable(&self.raw_vm_api());
            testnumbat_wasm::api::EndpointArgumentApi::check_num_arguments(&self.raw_vm_api(), 1i32);
            let initial_value = testnumbat_wasm::load_single_arg::<Self::Api, BigInt<Self::Api>>(
                self.raw_vm_api(),
                0i32,
        ...
        fn call_add(&self) {
            testnumbat_wasm::api::CallValueApi::check_not_payable(&self.raw_vm_api());
            testnumbat_wasm::api::EndpointArgumentApi::check_num_arguments(&self.raw_vm_api(), 1i32);
            let value = testnumbat_wasm::load_single_arg::<Self::Api, BigInt<Self::Api>>(
                self.raw_vm_api(),
                0i32,
                ArgId::from(&b"value"[..]),
            );
    ...
    pub trait ProxyTrait:
        testnumbat_wasm::contract_base::ProxyObjBase + super::module_1::ProxyTrait
    {
        fn get_sum(
            self,
        ) -> testnumbat_wasm::types::ContractCall<
            Self::Api,
            <BigInt<Self::Api> as testnumbat_wasm::io::EndpointResult>::DecodeAs,
        > {
            let (___api___, ___address___) = self.into_fields();
            let mut ___contract_call___ = testnumbat_wasm::types::new_contract_call(
                ___api___.clone(),
        ...
        ) -> ContractCall<Self::Api, <SCResult<()> as testnumbat_wasm::io::EndpointResult>::DecodeAs>
        {
            let (___api___, ___address___) = self.into_fields();
            let mut ___contract_call___ = testnumbat_wasm::types::new_contract_call(
                ___api___.clone(),
    ...
    where
        A: testnumbat_wasm::api::VMApi + Clone + 'static,
    {
        api: A,
    }
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////
    impl<A> testnumbat_wasm::contract_base::ContractBase for ContractObj<A>
    where
        A: testnumbat_wasm::api::VMApi + Clone + 'static,
    {
        type Api = A;
    ...
    impl<A> AutoImpl for ContractObj<A> where A: testnumbat_wasm::api::VMApi + Clone + 'static {}
    ...
    impl<A> EndpointWrappers for ContractObj<A> where A: testnumbat_wasm::api::VMApi + Clone + 'static {}

    impl<A> testnumbat_wasm::contract_base::CallableContract<A> for ContractObj<A>
    where
        A: testnumbat_wasm::api::VMApi + Clone + 'static,
    {
        fn call(&self, fn_name: &[u8]) -> bool {
    ...
    impl testnumbat_wasm::contract_base::ContractAbiProvider for AbiProvider {
        ...
        fn abi() -> testnumbat_wasm::abi::ContractAbi {
            ...
            contract_abi.coalesce(
                <super::module_1::AbiProvider as testnumbat_wasm::contract_base::ContractAbiProvider>::abi(),
            );
            contract_abi
        }
    }
    ...
    pub struct Proxy<A>
    where
        A: testnumbat_wasm::api::VMApi + 'static,
    {
        pub api: A,
        pub address: testnumbat_wasm::types::ManagedAddress<A>,
    }

    impl<A> testnumbat_wasm::contract_base::ProxyObjBase for Proxy<A>
    where
        A: testnumbat_wasm::api::VMApi + 'static,
    {
        type Api = A;
    ...
    impl<A> super::module_1::ProxyTrait for Proxy<A> where A: testnumbat_wasm::api::VMApi {}

    impl<A> ProxyTrait for Proxy<A> where A: testnumbat_wasm::api::VMApi {}
    ...
    impl<A> testnumbat_wasm::contract_base::CallbackProxyObjBase for CallbackProxyObj<A>
    where
        A: testnumbat_wasm::api::VMApi + 'static,
    {
        type Api = A;
    ...
    pub trait CallbackProxy: testnumbat_wasm::contract_base::CallbackProxyObjBase + Sized {
        fn my_callback(self, caller: &Address) -> testnumbat_wasm::types::CallbackClosure<Self::Api> {
            let mut ___callback_call___ =
                testnumbat_wasm::types::new_callback_call(self.cb_call_api(), &b"my_callback"[..]);
            ___callback_call___.push_endpoint_arg(caller);
            ___callback_call___
        }
    }
    impl<A> self::CallbackProxy for CallbackProxyObj<A> where A: testnumbat_wasm::api::VMApi + 'static {}
}

#[test]
fn test_add() {
    use testnumbat_wasm_debug::TxContext;
    ...
    let _ = testnumbat_wasm_debug::abi_json::contract_abi::<sample_adder::AbiProvider>();
}

fn contract_map() -> testnumbat_wasm_debug::ContractMap<testnumbat_wasm_debug::TxContext> {
    let mut contract_map = testnumbat_wasm_debug::ContractMap::new();
...
fn test_testdenali() {
    testnumbat_wasm_debug::testdenali_rs(
        "../contracts/examples/adder/testdenali/adder.scen.json",
        &contract_map(),
    );
}
