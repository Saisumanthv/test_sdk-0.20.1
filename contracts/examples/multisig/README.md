...
* **Minimal internal state.** Complex applications can be built inside of Testnumbat smart contracts. Storing minimal internal state allows our contract’s code to be simpler, and to be written in a more functional style, which is easier to test and reason about.
...
Multisig accounts are a critical safety feature for all users of the Testnumbat ecosystem. Decentralised applications will rely heavily upon multisig security.
