...
PING_PONG_CONTRACT="./test_sdk-0.0.2/contracts/examples/ping-pong-rewa"

PROXY_ARGUMENT="--proxy=https://devnet-api.testnumbat.com"
...
deploy_ping_pong() {
    ...
    (set -x; moapy contract deploy --bytecode="$PING_PONG_CONTRACT/output/ping-pong-rewa.wasm" \
        --pem="$PEM_FILE" \
