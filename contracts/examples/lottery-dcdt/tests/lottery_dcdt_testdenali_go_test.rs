...
fn complex_prize_distribution_go() {
    testnumbat_wasm_debug::testdenali_go("testdenali/complex-prize-distribution.scen.json");
}
...
fn lottery_with_burn_percentage_go() {
    testnumbat_wasm_debug::testdenali_go("testdenali/lottery-with-burn-percentage.scen.json");
}
