...
```
python3 ./interaction/playground.py --pem=my.pem --proxy=https://testnet-gateway.testnumbat.com
```

Interact with existing contract:

```
python3 ./interaction/playground.py --pem=my.pem --proxy=https://testnet-gateway.testnumbat.com --contract=moa1...
```
