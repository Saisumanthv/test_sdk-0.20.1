...
# copies wasm & testdenali files to the Andes test folder
...
cp -R contracts/feature-tests/composability/testdenali \
   $ANDES_PATH/test/features/composability
rm -f $ANDES_PATH/test/features/composability/testdenali-legacy/*
mmv -c 'contracts/feature-tests/composability/testdenali/*.scen.json' \
   $ANDES_PATH/test/features/composability/testdenali-legacy/l_'#1.scen.json'

sed -i 's/forwarder.wasm/forwarder-unmanaged.wasm/g' $ANDES_PATH/test/features/composability/testdenali-legacy/*
sed -i 's/forwarder-raw.wasm/forwarder-raw-unmanaged.wasm/g' $ANDES_PATH/test/features/composability/testdenali-legacy/*
sed -i 's/proxy-test-first.wasm/proxy-test-first-unmanaged.wasm/g' $ANDES_PATH/test/features/composability/testdenali-legacy/*
sed -i 's/proxy-test-second.wasm/proxy-test-second-unmanaged.wasm/g' $ANDES_PATH/test/features/composability/testdenali-legacy/*
sed -i 's/recursive-caller.wasm/recursive-caller-unmanaged.wasm/g' $ANDES_PATH/test/features/composability/testdenali-legacy/*
sed -i 's/proxy_test_init.scen.json/l_proxy_test_init.scen.json/g' $ANDES_PATH/test/features/composability/testdenali-legacy/*
