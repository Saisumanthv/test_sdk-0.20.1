...
def vec(name, items):
    """Generates the testdenali code for a ``VecMapper`` storage.
...
def set(name, items):
    """Generates the testdenali code for a ``SetMapper`` storage.
...
def map(name, pair_list):
    """Generates the testdenali code for a ``MapMapper`` storage.
