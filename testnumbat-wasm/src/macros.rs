// Note: Simple macros cannot be placed in testnumbat-wasm-derive,
...
macro_rules! imports {
    () => {
        ...
        use testnumbat_wasm::{
            ...
            testnumbat_codec::{DecodeError, NestedDecode, NestedEncode, TopDecode},
            err_msg,
            dcdt::*,
            io::*,
            non_zero_usize,
...
macro_rules! derive_imports {
    () => {
        use testnumbat_wasm::{
            derive::TypeAbi,
            testnumbat_codec,
            testnumbat_codec::testnumbat_codec_derive::{
...
macro_rules! sc_error {
    ($s:expr) => {
        testnumbat_wasm::types::SCResult::Err(testnumbat_wasm::types::StaticSCError::from($s)).into()
    };
}
...
macro_rules! sc_try {
    ($s:expr) => {
        match $s {
            testnumbat_wasm::types::SCResult::Ok(t) => t,
            testnumbat_wasm::types::SCResult::Err(e) => {
                return testnumbat_wasm::types::SCResult::Err(e);
            },
        }
    };
}
...
/// ```rust
/// # use testnumbat_wasm::*;
/// # use testnumbat_wasm::api::BlockchainApi;
/// # use testnumbat_wasm::types::{*, SCResult::Ok};
/// # pub trait ExampleContract: testnumbat_wasm::contract_base::ContractBase
/// # {
