...
use testnumbat_codec::testnumbat_codec_derive::{NestedDecode, NestedEncode, TopDecode, TopEncode};
...
impl<M: ManagedTypeApi> DcdtTokenPayment<M> {
    pub fn no_payment(api: M) -> Self {
        DcdtTokenPayment {
            ...
            token_identifier: TokenIdentifier::rewa(api.clone()),
            token_nonce: 0,
...
impl<M: ManagedTypeApi> ManagedVecItem<M> for DcdtTokenPayment<M> {
