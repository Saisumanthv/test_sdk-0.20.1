...
pub fn contract_implementation(
    ...
    let main_definition = quote! {
        ...
        testnumbat_wasm::contract_base::ContractBase
        + Sized
        #(#supertraits_main)*
        where
        {
    ...
    let endpoint_wrappers = quote! {
            ...
            #(#endpoint_wrapper_supertrait_decl)*
        {
            ...
            fn callback_selector(&self, mut ___cb_closure___: testnumbat_wasm::types::CallbackClosureForDeser<Self::Api>) -> testnumbat_wasm::types::CallbackSelectorResult<Self::Api> {
    ...
    let wasm_callback_fn = if is_contract_main {
        quote! {
            #[no_mangle]
            pub fn callBack () {
                let inst = super::endpoints::new_andes_instance();
    ...
    let wasm_endpoints = quote! {
        ...
        mod endpoints {
            ...
            fn new_andes_instance() -> super::ContractObj<testnumbat_wasm_node::AndesApiImpl> {
                let api = testnumbat_wasm_node::AndesApiImpl{};
