...
pub fn impl_auto_impl() -> proc_macro2::TokenStream {
    quote! {
        impl<A> AutoImpl for ContractObj<A> where
            A: testnumbat_wasm::contract_base::ContractBase
                + testnumbat_wasm::api::ErrorApi
                + testnumbat_wasm::api::EndpointArgumentApi
                + testnumbat_wasm::api::EndpointFinishApi
                + testnumbat_wasm::api::ManagedTypeApi
                + Clone
                + 'static
        {
        }
