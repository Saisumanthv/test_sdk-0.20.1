...
fn alloc_error_handler(_layout: alloc::alloc::Layout) -> ! {
	testnumbat_wasm_node::error_hook::signal_error(&b"allocation error"[..])
}
...
fn panic_fmt(panic_info: &core::panic::PanicInfo) -> ! {
	...
	testnumbat_wasm_node::error_hook::signal_error(panic_msg.as_bytes())
}

#[cfg(all(feature = "wasm-output-mode", not(feature = "panic-message")))]
#[panic_handler]
fn panic_fmt(_: &core::panic::PanicInfo) -> ! {
	testnumbat_wasm_node::error_hook::signal_error(&b"panic occurred"[..])
}
