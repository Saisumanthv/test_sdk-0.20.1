...
use testnumbat_codec::test_util::{check_top_decode, check_top_encode_decode};
...
impl testnumbat_codec::EncodeDefault for EnumWithDefault {
    fn is_default(&self) -> bool {
        *self == EnumWithDefault::Basic(0)
    }
}

impl testnumbat_codec::DecodeDefault for EnumWithDefault {
    fn default() -> Self {
