...
use testnumbat_codec::test_util::{check_top_decode, check_top_encode, check_top_encode_decode};
...
impl testnumbat_codec::EncodeDefault for TrickyDefaultDayOfWeek {
    fn is_default(&self) -> bool {
        matches!(self, TrickyDefaultDayOfWeek::Friday)
    }
}

impl testnumbat_codec::DecodeDefault for TrickyDefaultDayOfWeek {
    fn default() -> Self {
