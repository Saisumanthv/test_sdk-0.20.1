...
use testnumbat_codec::test_util::check_top_encode_decode;
...
impl<T> testnumbat_codec::EncodeDefault for StructOrDefault<T>
where
    T: NestedEncode + NestedDecode + Default + 'static,
{
...
impl<T> testnumbat_codec::DecodeDefault for StructOrDefault<T>
where
    T: NestedEncode + NestedDecode + Default + 'static,
{
    fn default() -> Self {
